/********************************************************************************
** Form generated from reading UI file 'pathgawidget.ui'
**
...
#ifndef UI_PATHGAWIDGET_H
#define UI_PATHGAWIDGET_H
...
class Ui_PathGAWidget
{
public:
    QVBoxLayout *verticalLayout_2;
    QHBoxLayout *horizontalLayout;
    QCustomPlot *path_CusPlot;
    ...
    void setupUi(QWidget *PathGAWidget)
    {
        if (PathGAWidget->objectName().isEmpty())
            PathGAWidget->setObjectName("PathGAWidget");
        PathGAWidget->resize(945, 651);
        verticalLayout_2 = new QVBoxLayout(PathGAWidget);
        ...
        path_CusPlot = new QCustomPlot(PathGAWidget);
        path_CusPlot->setObjectName("path_CusPlot");
        path_CusPlot->setMinimumSize(QSize(0, 300));

        horizontalLayout->addWidget(path_CusPlot);

        iter_CusPlot = new QCustomPlot(PathGAWidget);
        ...
        plainTextEdit = new QPlainTextEdit(PathGAWidget);
        plainTextEdit->setObjectName("plainTextEdit");
        plainTextEdit->setEnabled(true);
        plainTextEdit->setMinimumSize(QSize(300, 300));
        plainTextEdit->setMaximumSize(QSize(16777215, 400));
        ...
        para_Set = new QGroupBox(PathGAWidget);
        ...
        var_Spin->setMaximum(0.900000000000000);
        ...
        retranslateUi(PathGAWidget);

        QMetaObject::connectSlotsByName(PathGAWidget);
    } // setupUi

    void retranslateUi(QWidget *PathGAWidget)
    {
        PathGAWidget->setWindowTitle(QCoreApplication::translate("PathGAWidget", "Form", nullptr));
        para_Set->setTitle(QCoreApplication::translate("PathGAWidget", "\345\217\202\346\225\260\350\256\276\347\275\256", nullptr));
        selectAlgo_GB->setTitle(QCoreApplication::translate("PathGAWidget", "\351\200\211\346\213\251\347\256\227\346\263\225", nullptr));
        wheel_Btn->setText(QCoreApplication::translate("PathGAWidget", "\350\275\256\347\233\230", nullptr));
        prize_Btn->setText(QCoreApplication::translate("PathGAWidget", "\344\272\214\345\205\203\351\224\246\346\240\207", nullptr));
        return_funcMain->setText(QCoreApplication::translate("PathGAWidget", "\350\277\224\345\233\236", nullptr));
        label_2->setText(QCoreApplication::translate("PathGAWidget", "\344\272\244\345\217\211\346\205\250\347\216\207:", nullptr));
        startAlgo->setText(QCoreApplication::translate("PathGAWidget", "\345\274\200\345\247\213", nullptr));
        label_4->setText(QCoreApplication::translate("PathGAWidget", "\350\277\255\344\273\243\346\254\241\346\225\260:", nullptr));
        label_3->setText(QCoreApplication::translate("PathGAWidget", "\345\217\230\345\274\202\346\246\202\347\216\207:", nullptr));
        label->setText(QCoreApplication::translate("PathGAWidget", "\347\247\215\347\276\244\345\244\247\345\260\217:", nullptr));
    } // retranslateUi

};

namespace Ui {
    class PathGAWidget: public Ui_PathGAWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_PATHGAWIDGET_H
