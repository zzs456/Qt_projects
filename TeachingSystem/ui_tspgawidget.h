/********************************************************************************
** Form generated from reading UI file 'tspgawidget.ui'
**
...
#ifndef UI_TSPGAWIDGET_H
#define UI_TSPGAWIDGET_H
...
class Ui_TSPGAWidget
{
public:
    QVBoxLayout *verticalLayout_2;
    QHBoxLayout *horizontalLayout;
    QCustomPlot *tsp_CusPlot;
    ...
    void setupUi(QWidget *TSPGAWidget)
    {
        if (TSPGAWidget->objectName().isEmpty())
            TSPGAWidget->setObjectName("TSPGAWidget");
        TSPGAWidget->resize(740, 635);
        verticalLayout_2 = new QVBoxLayout(TSPGAWidget);
        ...
        tsp_CusPlot = new QCustomPlot(TSPGAWidget);
        tsp_CusPlot->setObjectName("tsp_CusPlot");
        tsp_CusPlot->setMinimumSize(QSize(0, 300));

        horizontalLayout->addWidget(tsp_CusPlot);

        iter_CusPlot = new QCustomPlot(TSPGAWidget);
        ...
        plainTextEdit = new QPlainTextEdit(TSPGAWidget);
        ...
        para_Set = new QGroupBox(TSPGAWidget);
        ...
        retranslateUi(TSPGAWidget);

        QMetaObject::connectSlotsByName(TSPGAWidget);
    } // setupUi

    void retranslateUi(QWidget *TSPGAWidget)
    {
        TSPGAWidget->setWindowTitle(QCoreApplication::translate("TSPGAWidget", "Form", nullptr));
        para_Set->setTitle(QCoreApplication::translate("TSPGAWidget", "\345\217\202\346\225\260\350\256\276\347\275\256", nullptr));
        selectAlgo_GB->setTitle(QCoreApplication::translate("TSPGAWidget", "\351\200\211\346\213\251\347\256\227\346\263\225", nullptr));
        wheel_Btn->setText(QCoreApplication::translate("TSPGAWidget", "\350\275\256\347\233\230", nullptr));
        prize_Btn->setText(QCoreApplication::translate("TSPGAWidget", "\344\272\214\345\205\203\351\224\246\346\240\207", nullptr));
        return_funcMain->setText(QCoreApplication::translate("TSPGAWidget", "\350\277\224\345\233\236", nullptr));
        label_2->setText(QCoreApplication::translate("TSPGAWidget", "\344\272\244\345\217\211\346\205\250\347\216\207:", nullptr));
        startAlgo->setText(QCoreApplication::translate("TSPGAWidget", "\345\274\200\345\247\213", nullptr));
        label_4->setText(QCoreApplication::translate("TSPGAWidget", "\350\277\255\344\273\243\346\254\241\346\225\260:", nullptr));
        label_3->setText(QCoreApplication::translate("TSPGAWidget", "\345\217\230\345\274\202\346\246\202\347\216\207:", nullptr));
        label->setText(QCoreApplication::translate("TSPGAWidget", "\347\247\215\347\276\244\345\244\247\345\260\217:", nullptr));
    } // retranslateUi

};

namespace Ui {
    class TSPGAWidget: public Ui_TSPGAWidget {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TSPGAWIDGET_H
