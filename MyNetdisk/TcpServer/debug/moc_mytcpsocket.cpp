...
Q_CONSTINIT static const qt_meta_stringdata_CLASSMyTcpSocketENDCLASS_t qt_meta_stringdata_CLASSMyTcpSocketENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(12, 15),  // "MyOfflineSignal"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 12),  // "MyTcpSocket*"
        QT_MOC_LITERAL(42, 7),  // "recvMsg"
        QT_MOC_LITERAL(50, 7),  // "Offline"
        QT_MOC_LITERAL(58, 16)   // "sendFileToClient"
    },
    "MyTcpSocket",
    "MyOfflineSignal",
    "",
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->MyOfflineSignal((*reinterpret_cast< std::add_pointer_t<MyTcpSocket*>>(_a[1]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &MyTcpSocket::MyOfflineSignal; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::MyOfflineSignal(MyTcpSocket * _t1)
{
